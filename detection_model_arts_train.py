...
if __name__ == '__main__':
    ...
    train_valid(in_channels=3, out_channels=8, net_name="yolov3", lr=0.001,
                train_csv_path="seed-project/data_list/huawei_rubbish_train.csv",
                # train_csv_path="./data_list/train3.csv",
                load_train_data=copy_dataset(copy_to_local_root="/cache/datasets",
                                             source_data_path="s3://zlf-rubbish-data/datasets/trainval.zip"
                                             ),
                valid_csv_path="seed-project/data_list/huawei_rubbish_valid.csv",
                # valid_csv_path="./data_list/valid3.csv",
                load_valid_data=copy_dataset(copy_to_local_root="/cache/datasets",
                                             source_data_path="s3://zlf-rubbish-data/datasets/trainval.zip"
                                             ),
                batch_size=22, resize=(512, 512), crop_offset=(0, 0),
                epoch_begin=0, epoch_num=10,
                num_classes=44,
                load_classes=read_lines("/cache/datasets/trainval/train_classes.txt"),
                ...
                #     pretrained_weights_path=r"C:\Users\zlf\.cache\torch\checkpoints\resnet101-5d3b4d8f.pth",
                #     copy_to_local_root=None),
                yolov3_model_json='seed-project/nets/yolo/yolov3-44.json',
                load_state_dict=load_weight(pretrained_weights_path="s3://zlf-rubbish-data/outputs/ckpt_8_6470.39_0.00.pth",
                    copy_to_local_root="/cache/")
                )
